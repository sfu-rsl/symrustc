...
"cmake" \
  ...
  "-DLLVM_EXTERNAL_PROJECTS=symcc" \
  "-DLLVM_EXTERNAL_SYMCC_SOURCE_DIR=$HOME/belcarra_source0/src/rs/rust_source/src/llvm-project/symcc" \
  "-DZ3_TRUST_SYSTEM_VERSION=on" \
  "-DQSYM_BACKEND=$SYMRUSTC_QSYM_BACKEND" \
