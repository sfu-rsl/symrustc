...
COPY --chown=ubuntu:ubuntu --from=builder_libafl_ex_image $SYMRUSTC_LIBAFL_EX_IMAGE_DIR/fuzzer/target $SYMRUSTC_LIBAFL_EX_IMAGE_DIR/fuzzer/target
...
COPY --chown=ubuntu:ubuntu --from=builder_libafl_ex_image $SYMRUSTC_LIBAFL_EX_IMAGE_DIR/runtime/target $SYMRUSTC_LIBAFL_EX_IMAGE_DIR/runtime/target
